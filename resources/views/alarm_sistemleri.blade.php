...
<body class="page-urunler-ve-hizmetler">
  ...
  <main>
    <section class="products-banner" aria-labelledby="page-title">
      ...
      <div class="container">
        <h1 id="page-title">Tepenet Alarm Sistemleri</h1>
        <nav aria-label="Sayfa yolu">
          <ol class="breadcrumb-list">
            ...
            <li aria-hidden="true">›</li>
            <li aria-current="page">Alarm Sistemleri</li>
          </ol>
        </nav>
      </div>
    </section>
        ...
        <div class="row g-4 g-xl-5 align-items-start">
          ...
          <div class="col-12 col-lg-9">
            <div class="category-grid row row-cols-1 row-cols-md-2 g-4">
              <div class="col">
                <a class="category-card" href="{{ route('urunler-ve-hizmetler.kategori', ['sistem' => 'alarm-sistemleri', 'urunKategori' => 'kablosuz-alarm-sistemi']) }}">
                  <div class="category-card__visual">
                    <img src="{{ asset('resimler/urunler/kablosuz_alarm.png') }}" alt="Alarm sistemleri ürün grubu" />
                  </div>
                  <div class="category-card__body">
                    <div>
                      <h2>Kablosuz Alarm Sistemleri</h2>
                    </div>
              ...
              <div class="col">
                <a class="category-card" href="{{ route('urunler-ve-hizmetler.kategori', ['sistem' => 'alarm-sistemleri', 'urunKategori' => 'kablolu-alarm-sistemi']) }}">
                  <div class="category-card__visual">
                    <img src="{{ asset('resimler/urunler/kablolu_alarm.png') }}" alt="Kamera sistemleri ürün grubu" />
                  </div>
                  <div class="category-card__body">
                    <div>
                      <h2>Kablolu Alarm Sistemleri</h2>
                    </div>
                    <span class="category-card__arrow" aria-hidden="true">→</span>
                  </div>
                </a>
