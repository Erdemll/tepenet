      ...
      <div class="container">
        ...
        <div class="desktop-navigation d-none d-xl-flex ms-auto">
          <ul class="navbar-nav align-items-center gap-2">
              ...
              <ul class="dropdown-menu bg-danger">
                <li>
                  <a
                    ...
                    href="{{ route('ev-guvenligi.index') }}">Ev Alarm Sistemleri</a>
                </li>
                <li>
                  <a
                    class="fs-6 text-white dropdown-item"
                    href="{{ route('ev-guvenligi.nelerden-olusur') }}">Nelerden Oluşur?</a>
                </li>
                <li>
                  <a
                    class="fs-6 text-white dropdown-item"
                    href="{{ route('ev-guvenligi.nasil-calisir') }}">Nasıl Çalışır?</a>
                </li>
              </ul>
            </li>
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu bg-danger">
                <li>
                  <a
                    class="fs-6 text-white dropdown-item"
                    href="{{ route('is-yeri-guvenligi.index') }}">İş Yeri Alarm Sistemleri</a>
                </li>
                <li>
                  <a
                    class="fs-6 text-white dropdown-item"
                    href="{{ route('is-yeri-guvenligi.nelerden-olusur') }}">Nelerden Oluşur?</a>
                </li>
                <li>
                  <a
                    class="fs-6 text-white dropdown-item"
                    href="{{ route('is-yeri-guvenligi.nasil-calisir') }}">Nasıl Çalışır?</a>
                </li>
              </ul>
            </li>
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu bg-danger">
                <li>
                  <a
                    class="fs-6 text-white dropdown-item"
                    href="{{ route('kurumsal-cozumler.index') }}">Kurumsal Güvenlik çözümleri</a>
                </li>
              </ul>
            </li>
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu bg-danger">
                <li>
                  <a
                    class="fs-6 text-white dropdown-item"
                    href="{{ route('kendi-sistemini-olustur.index') }}">Kurumsal Alarm çözümleri</a>
                </li>
              </ul>
            </li>
            ...
            <!--
             <li class="nav-item">
              <a class="desktop-nav-link text-danger" href="{{ route('bloglar.index') }}">
