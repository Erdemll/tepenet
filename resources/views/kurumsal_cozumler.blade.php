  ...
  <main>
    <section class="hero corporate-hero" id="ucretsiz-kesif" aria-labelledby="page-title">
      ...
      <aside class="hero-request" aria-labelledby="callback-title">
        ...
        <form action="{{ route('discovery.store') }}" method="post" data-corporate-discovery-form>
          @csrf
          <input type="hidden" name="source_page" value="kurumsal-cozumler" />

          <div class="row g-2">
            <div class="col-12">
              <label class="visually-hidden" for="kurumsal-telefon">Telefon numaranız</label>
              <input class="form-control @error('telefon') is-invalid @enderror" id="kurumsal-telefon" name="telefon" type="tel" inputmode="tel" maxlength="20" placeholder="Telefon Numaranız" autocomplete="tel" value="{{ old('telefon') }}" required />
              @error('telefon')
            ...
            <div class="col-12 col-sm-6">
              ...
              <input class="form-control @error('ad') is-invalid @enderror" id="kurumsal-ad" name="ad" type="text" maxlength="100" placeholder="Adınız" autocomplete="given-name" value="{{ old('ad') }}" required />
              @error('ad')
              <div class="invalid-feedback">{{ $message }}</div>
              @enderror
            </div>
            <div class="col-12 col-sm-6">
              ...
              <input class="form-control @error('soyad') is-invalid @enderror" id="kurumsal-soyad" name="soyad" type="text" maxlength="100" placeholder="Soyadınız" autocomplete="family-name" value="{{ old('soyad') }}" required />
              @error('soyad')
              <div class="invalid-feedback">{{ $message }}</div>
              @enderror
            </div>
            ...
            <div class="col-12 col-sm-6">
              ...
              <input class="form-control @error('email') is-invalid @enderror" id="kurumsal-email" name="email" type="email" maxlength="255" placeholder="E-Posta" autocomplete="email" value="{{ old('email') }}" />
              @error('email')
              <div class="invalid-feedback">{{ $message }}</div>
              @enderror
            </div>
            <div class="col-12">
              ...
              <input class="form-control @error('firma_adi') is-invalid @enderror" id="kurumsal-firma" name="firma_adi" type="text" maxlength="150" placeholder="Firma Adı" autocomplete="organization" value="{{ old('firma_adi') }}" required />
              @error('firma_adi')
              <div class="invalid-feedback">{{ $message }}</div>
              @enderror
            </div>
            <div class="col-12 col-sm-7">
              ...
              <select class="form-select @error('kurum_turu') is-invalid @enderror" id="kurum-turu" name="kurum_turu" required>
                <option value="" @selected(! old('kurum_turu')) disabled>Kurum Türü Seçiniz</option>
                <option value="magaza" @selected(old('kurum_turu')==='magaza' )>Mağaza / Perakende</option>
                <option value="ofis" @selected(old('kurum_turu')==='ofis' )>Ofis</option>
                <option value="fabrika" @selected(old('kurum_turu')==='fabrika' )>Fabrika / Üretim</option>
                <option value="otel" @selected(old('kurum_turu')==='otel' )>Otel / Konaklama</option>
                <option value="diger" @selected(old('kurum_turu')==='diger' )>Diğer</option>
              </select>
              @error('kurum_turu')
              <div class="invalid-feedback">{{ $message }}</div>
              @enderror
            ...
            <div class="col-12 col-sm-5">
              ...
              <input class="form-control @error('sube_sayisi') is-invalid @enderror" id="kurumsal-sube" name="sube_sayisi" type="number" min="1" max="10000" placeholder="Şube Sayısı" value="{{ old('sube_sayisi') }}" required />
              @error('sube_sayisi')
              <div class="invalid-feedback">{{ $message }}</div>
              @enderror
            </div>
            <div class="col-12">
              <div class="form-check mt-1">
                <input class="form-check-input" id="kurumsal-kampanya" name="kampanya_izni" type="checkbox" value="1" @checked(old('kampanya_izni')) />
            ...
            <div class="col-12">
              <div class="form-check">
                <input class="form-check-input @error('kvkk_onayi') is-invalid @enderror" id="kurumsal-kvkk" name="kvkk_onayi" type="checkbox" value="1" @checked(old('kvkk_onayi')) required />
