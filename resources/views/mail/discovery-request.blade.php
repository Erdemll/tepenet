...
<head>
    ...
    <title>Yeni Ücretsiz Keşif Talebi</title>
    <style>
        body {
            margin: 0;
            padding: 0;
...
<body data-template="tepenet-discovery">
            ...
            <table class="email-card" role="presentation" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <td class="brand-header">
                        <img
                            class="brand-logo"
                            src="cid:{{ \App\Mail\DiscoveryRequestMail::LOGO_CONTENT_ID }}"
                            width="230"
                ...
                <tr>
                    <td class="hero">
                        <span class="eyebrow">Yeni Talep</span>
                        <h1 class="hero-title">Ücretsiz keşif talebi alındı</h1>
                        <p class="hero-copy">
                            Web sitesi üzerinden yeni bir müşteri adayı bilgilerini iletti.
                            Talep ayrıntılarını aşağıda bulabilirsiniz.
                        </p>
                    </td>
                </tr>
                <tr>
                    <td class="content">
                        <h2 class="section-title">Talep bilgileri</h2>
                        ...
                        <table class="details" role="presentation" cellpadding="0" cellspacing="0">
                            ...
                            @if ($isWorkplace)
                                <tr>
                                    ...
                                    <td class="details-value">{{ $branchCount }}</td>
                                </tr>
                            @endif
                            <tr>
