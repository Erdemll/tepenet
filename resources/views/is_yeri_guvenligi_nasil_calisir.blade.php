...
<html lang="tr">
  <head>
    ...
    <meta
      name="description"
      content="Tepenet iş yeri alarm sisteminin alarm anında nasıl çalıştığını ve izleme merkezi sürecini inceleyin."
    />
    <title>İş Yeri Alarm Sistemi Nasıl Çalışır? | Tepenet Güvenlik</title>
  ...
  <body class="page-is-yeri-guvenligi-nasil-calisir">
        ...
        <div class="container">
          <div class="row g-4 g-lg-5">
            <div class="col-12 col-lg-3">
              <nav aria-label="İş yeri güvenliği sayfaları">
                <ul class="process-navigation">
                  <li>
                    <a href="{{ route('is-yeri-guvenligi.index') }}">İş Yeri Alarm Sistemleri</a>
                  </li>
                  <li><a href="#">Çok Şubeli İşletmem/Zincir Mağazam</a></li>
                  <li><a href="{{ route('is-yeri-guvenligi.nelerden-olusur') }}">Nelerden Oluşur</a></li>
                  <li>
                    <a
                      class="active"
            ...
            <div class="col-12 col-lg-9 process-content">
              ...
              <h2 id="process-title">
                Tepenet İş Yeri Alarm Sistemi Nasıl Çalışır?
              </h2>
              <ol class="process-steps">
                <li>
                  Devreye alınan iş yeri alarm sisteminde, dış kapıda bulunan
                ...
                <li>
                  Şifre girildikten sonra iş yeri alarm sistemi devre dışı
                  bırakılır (15 saniyelik uyarı sinyali boyunca sirenler devreye
                  girmemektedir).
                </li>
                <li>
                ...
                <li>
                  İş yeri alarmlarının devreye girme sinyali, Alarm İzleme
                  Merkezi temsilcisinin ekranında belirir.
                </li>
    ...
    <a class="floating-discovery" href="{{ route('is-yeri-guvenligi.index') }}#ucretsiz-kesif"
