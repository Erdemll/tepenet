...
<body class="page-kendi-sistemini-olustur">
          ...
          <div
            ...
            <ol class="builder-progress">
              ...
              <li data-progress-step="2">
                <span class="builder-progress__marker">2</span><span class="visually-hidden">Kullanım alanı</span>
              </li>
              <li data-progress-step="3">
                <span class="builder-progress__marker">3</span><span class="visually-hidden">Risk noktası</span>
              </li>
              <li data-progress-step="4">
                <span class="builder-progress__marker">4</span><span class="visually-hidden">Kapı ve pencere sayısı</span>
              </li>
              <li data-progress-step="5">
                <span class="builder-progress__marker">5</span><span class="visually-hidden">Sistem tercihi</span>
              </li>
              <li data-progress-step="6">
                <span class="builder-progress__marker">6</span><span class="visually-hidden">Risk bulunan alan ihtiyaç listesi</span>
              </li>
              <li data-progress-step="7">
                <span class="builder-progress__marker">7</span><span class="visually-hidden">Standart ihtiyaç listesi</span>
              </li>
              <li data-progress-step="8">
                <span class="builder-progress__marker">8</span><span class="visually-hidden">İletişim formu</span>
              </li>
              <li data-progress-step="9">
                <span class="builder-progress__marker">9</span><span class="visually-hidden">Tamamlandı</span>
              </li>
            </ol>
          </div>
          ...
          <div class="builder-stage" aria-live="polite">
            ...
            <section
              ...
              <div
                ...
                <label class="builder-choice">
                  <input type="radio" name="kullanim_alani" value="Ev" @checked(old('talep_alani') === 'Ev') />
                  <span>Ev</span>
                </label>
                <label class="builder-choice">
                  <input type="radio" name="kullanim_alani" value="İş Yeri" @checked(old('talep_alani') === 'İş Yeri') />
                  <span>İş Yeri</span>
                </label>
              </div>
              <p
            ...
            <section
              ...
              <div
                ...
                aria-labelledby="adim-3-baslik">
                <label class="builder-choice">
                  <input type="radio" name="risk_noktasi" value="Evet" @checked(old('risk_durumu') === 'Evet') />
                  <span>Evet</span>
                </label>
                <label class="builder-choice">
                  <input type="radio" name="risk_noktasi" value="Hayır" @checked(old('risk_durumu') === 'Hayır') />
                  <span>Hayır</span>
                </label>
              </div>
              <p
            ...
            <section
              ...
              <div class="builder-number">
                <label for="riskli-nokta-sayisi">Kapı ve pencere sayısı</label>
                <input
                  class="form-control"
            ...
            <section
              ...
              <div
                ...
                aria-labelledby="adim-5-baslik">
                <label class="builder-choice">
                  <input type="radio" name="sistem_tercihi" value="Kablolu" @checked(old('sistem_tercihi') === 'Kablolu') />
                  <span>Kablolu</span>
                </label>
                <label class="builder-choice">
                  <input
                    ...
                    name="sistem_tercihi"
                    value="Kablosuz"
                    @checked(old('sistem_tercihi') === 'Kablosuz') />
                  <span>Kablosuz</span>
                </label>
              </div>
              <p
            ...
            <section
              ...
              <div class="recommendation-card">
                ...
                <ul class="recommendation-list">
                  ...
                  <li>
                    <span>Manyetik kontak</span><strong><span data-output="contact-count">1</span> adet</strong>
                  </li>
            ...
            <section
              ...
              <form class="builder-form" action="{{ route('kendi-sistemini-olustur.store') }}" method="post" novalidate>
                @csrf
                <input type="hidden" id="talep-alani" name="talep_alani" value="{{ old('talep_alani') }}" />
                <input type="hidden" id="talep-risk" name="risk_durumu" value="{{ old('risk_durumu') }}" />
                <input
                  type="hidden"
                ...
                <div class="row g-3">
                  ...
                  <div class="col-12">
                    <label class="visually-hidden" for="kesif-not">Eklemek istediğiniz not</label>
                    <textarea
                      class="form-control"
                      id="kesif-not"
                      name="not"
                      maxlength="2000"
                      placeholder="Eklemek istediğiniz not">{{ old('not') }}</textarea>
                  </div>
                  <div class="col-12">
                    <div class="form-check">
                      ...
                      <label class="form-check-label" for="kampanya-izni">Tepenet Güvenlik’in kampanya ve duyurular için
                  ...
                  <div class="col-12">
                    <div class="form-check">
                      <input
                        ...
                        value="1"
                        required />
                      <label class="form-check-label" for="kvkk-onayi">Kişisel verilerin korunmasına ilişkin
                ...
                <div
                  ...
                  data-form-error
                  aria-live="assertive">
                  @if (session('system_builder_error'))
                    {{ session('system_builder_error') }}
                  @elseif ($errors->any())
                    <ul class="mb-0">
            ...
            <section
              ...
              <h2 id="adim-9-baslik">Talebiniz bize ulaştı</h2>
              <p class="builder-step__lead">
                {{ session('system_builder_success', 'Seçimleriniz ve iletişim bilgileriniz Tepenet ekibine iletildi.') }}
              </p>
              <div class="builder-actions">
                <button
                  class="builder-button btn"
  ...
  <script>
    ...
    const initialStep = @json(session()->has('system_builder_success') ? 9 : ($errors->any() || session()->has('system_builder_error') ? 8 : 1));
